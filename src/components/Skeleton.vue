<template>
  <div class="mx-5">
    <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 flex items-center flex-col md:flex-row">
      <div class="flex items-center justify-center w-full max-w-[225px] h-80 bg-gray-300 rounded md:w-80 dark:bg-grey">
